...
mr ("function () { emit(this.program.name, { count: 1 }); }", "programs")
mr ("function () { emit(this.host, { count: 1 }); }", "hosts")
mr ("function () { d = new Date (this.ts*1000); d.setMinutes(0); d.setSeconds(0); emit(d.valueOf()/1000, { count: 1 }); }",
    "time")
